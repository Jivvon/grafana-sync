...
func init() {
	...
	rootCmd.PersistentFlags().StringP("directory", "d", ".", "Directory where to save or load dashboards")
	...
	pullDashboardsCmd.PersistentFlags().StringP("tag", "t", "", "Dashboard tag to read")
